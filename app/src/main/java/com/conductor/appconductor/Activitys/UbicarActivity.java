        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(UbicarActivity.this, "Best Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(UbicarActivity.this, "Network Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        public void onLocationChanged(Location location) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(UbicarActivity.this, "GPS Provider update", Toast.LENGTH_SHORT).show();
                }
            });
        }
        @Override
